<template>
  <v-page title="确认下单">
    ...
    <div class="page-content">
      <div class="wdddbg">
          <span><van-icon name="passed" style='font-size:20px;margin:18px 10px 0;float:left;'/>积分订单</span>
...
<style scoped>
  ...
  .van-card__thumb img{height:100%}
  .van-card__desc{font-size:18px;color:red;margin-top:10px}
</style>
