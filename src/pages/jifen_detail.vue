    ...
    <div class="content">
      ...
      <van-popup v-model="show" @close="onClose" position='bottom'>
        <div class='sku_shop'>
          ...
          <div style='width:60%'>
            <p style='color:red;font-size:20px;line-height:40px'>{{shop.point}}积分</p>
  ...
  export default {
    ...
    methods:{
      ...
      openPage(str,id,type){
        this.$router.push({name:str,query: {buyType:0,type:3,"id":"0","goods_id":this.$route.query.type_id,"goods_sku_id":this.fenleiid,"goods_nums":this.num,goods_name:this.shop.goods_name,point:this.shop.point,image_uri:this.shop.image_uri }});
      },
      index_info(){
        this.$ajax('pointDetail',{
