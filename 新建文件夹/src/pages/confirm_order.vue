<template>
  <v-page title="确认下单">
    ...
    <div class="page-content">
      ...
      <div class='listtext'>共2件商品 实付款：<span>￥{{allprice}}</span></div>
  ...
  export default {
      ...
      return {
        listinfo:{
          ...
          shopInfo:[{
            ...
            sale_price:this.$route.query.sale_price,
    ...
    methods: {
      ...
      submit() { //提交支付
        ...
        'buyType':this.listinfo.buyType,
        'type':this.$route.query.type,
        'goods':this.goods,
        'coupon_id':this.$getStorage('id'),
        'coupon_price':this.$getStorage('price'),
